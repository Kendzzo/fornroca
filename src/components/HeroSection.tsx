  ...
  return (
    <section className="relative min-h-screen flex items-end pb-16 md:pb-24 overflow-hidden">
      ...
      <div className="absolute inset-0 z-0">
        <img
          src={bakeryStorefront}
          alt="Forn Roca storefront"
      ...
      <div className="container-editorial relative z-10">
        <motion.div
          ...
          className="max-w-3xl"
        >
          <span className="text-caption text-foreground/70 block mb-4">
            {t('hero.tagline')}
          </span>
          ...
          <p className="text-editorial text-foreground/80 max-w-xl">
            {t('hero.subtitle')}
          </p>
        </motion.div>
      </div>
